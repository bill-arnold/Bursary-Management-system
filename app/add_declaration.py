...
add_declaration_documents = Blueprint('add_declaration_documents', __name__)

declaration_documents_schema = DeclarationDocumentsSchema()

@add_declaration_documents.route('/add_declaration_documents', methods=['POST'])
def add_declaration_documents_function():
