...
add_personal_details = Blueprint('add_personal_details', __name__)

student_details_schema = StudentDetailsSchema()

@add_personal_details.route('/add_personal_details', methods=['POST'])
def add_personal_details_function():
    ...
    return {"message": "Personal details added successfully.", "student_details": result}, 201
